---
name: refund-loss-analysis
description: Quantify refund leakage and root causes with accounting-linkage remediation actions.
metadata:
  version: 0.1.0
  category: ecommerce
  owner: Finance & Tax
...
## Mission
Provide decision support for refund loss analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
