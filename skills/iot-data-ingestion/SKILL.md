...
description: Supports MQTT/CoAP/OPC-UA protocols for sensor data processing and edge-to-cloud synchronization.
metadata:
  version: "0.1.0"
...
Supports MQTT/CoAP/OPC-UA protocols for sensor data processing and edge-to-cloud synchronization.

## Activation Triggers

- Invoked by `sdlc-orchestration` when the objective requires iot data ingestion capability
