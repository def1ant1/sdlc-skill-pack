...
description: Ecommerce extension skill for vendor-network-analysis with organizational-memory-aware analysis and safety controls.
metadata:
  version: 0.1.0
...
## Purpose
Supports ecommerce decision workflows for **vendor-network-analysis**.
