---
name: listing-quality-scoring
description: Listing Quality Scoring skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support listing quality scoring decisions in **draft mode** by default; block publish actions pending explicit approval.
