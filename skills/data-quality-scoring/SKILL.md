...
description: Score data quality dimensions for mastered entities and route remediation workflows through master data management.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Score data quality dimensions for mastered entities and route remediation workflows through master data management.
