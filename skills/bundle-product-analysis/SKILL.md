---
name: bundle-product-analysis
description: Bundle Product Analysis skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support bundle product analysis decisions in **draft mode** by default; block publish actions pending explicit approval.
