---
name: local-market-trend-analysis
description: Analyze local market velocity, seasonality, and pricing momentum for arbitrage planning.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Provide decision support for local market trend analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
