...
description: Interprets charts, dashboard screenshots, and diagrams as structured enterprise intelligence.
metadata:
  version: "0.1.0"
  category: multimodal
  owner: platform
...
Interprets charts, dashboard screenshots, and diagrams as structured enterprise intelligence.

## Activation Triggers

- Invoked by `sdlc-orchestration` when the objective requires visual analytics capability
