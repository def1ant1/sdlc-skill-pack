...
description: Manages Salesforce/HubSpot pipeline, contact synchronization, and opportunity analysis.
metadata:
  version: "0.1.0"
...
Manages Salesforce/HubSpot pipeline, contact synchronization, and opportunity analysis.

## Activation Triggers

- Invoked by `sdlc-orchestration` when the objective requires crm integration capability
