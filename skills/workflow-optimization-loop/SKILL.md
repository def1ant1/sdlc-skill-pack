---
name: workflow-optimization-loop
description: Workflow Optimization Loop skill for SDLC skill-pack operations.
metadata:
  version: 0.1.0
  category: operations
  owner: Apotheon.ai
...
Provide structured execution for workflow optimization loop workflows.
