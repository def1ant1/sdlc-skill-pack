...
description: Regional demand scoring for resale opportunities with logistics-aware arbitrage prioritization.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Provide decision support for regional demand analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
