...
description: Support-only tax planning scenario preparation with non-advisory compliance messaging and mandatory reviewer sign-off.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Support-only tax planning scenario preparation with non-advisory compliance messaging and mandatory reviewer sign-off.
