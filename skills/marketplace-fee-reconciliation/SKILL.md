...
description: Reconcile marketplace fees against payouts/orders and map variances to accounting entities.
metadata:
  version: 0.1.0
  category: ecommerce
  owner: Finance & Tax
...
## Mission
Provide decision support for marketplace fee reconciliation in **draft mode** with explicit evidence, assumptions, and confidence scoring.
