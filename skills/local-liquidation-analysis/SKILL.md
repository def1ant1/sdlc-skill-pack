---
name: local-liquidation-analysis
...
# Local Liquidation Analysis

## Role
Execute local liquidation analysis workflows while producing canonical, policy-aware decision-support artifacts.
