---
name: offer-strategy-analysis
description: Model offer strategies and fallback ladders with explicit human-approval boundaries.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Provide decision support for offer strategy analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
