---
name: persona-modeling
description: Phase 108 business skill using canonical entity/event outputs and policy-gated actions.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Execute persona modeling workflows while producing only canonical entity/event artifacts.

## Routing
- use_when: Request maps to phase 108 capabilities and requires structured decision support.
