---
name: hr-policy-guidance-support
description: Support-only HR policy guidance drafts with bias and human-sensitivity guardrails and mandatory HR review.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Support-only HR policy guidance drafts with bias and human-sensitivity guardrails and mandatory HR review.
