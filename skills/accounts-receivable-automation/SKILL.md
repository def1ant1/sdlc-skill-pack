...
description: Phase 104 business skill using canonical entity/event outputs and policy-gated actions.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Execute accounts receivable automation workflows while producing only canonical entity/event artifacts.
