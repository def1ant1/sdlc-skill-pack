---
name: product-lifecycle-intelligence
description: Phase 111 business skill using canonical entity/event outputs and policy-gated
  actions.
metadata:
  version: 9.0.0
  category: sdlc
...
## Role
Execute product lifecycle intelligence workflows while producing only canonical entity/event artifacts.
