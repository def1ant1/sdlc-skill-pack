---
name: sla-risk-detection
description: Phase 109 business skill using canonical entity/event outputs and policy-gated actions.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Execute sla risk detection workflows while producing only canonical entity/event artifacts.

## Routing
- use_when: Request maps to phase 109 capabilities and requires structured decision support.
