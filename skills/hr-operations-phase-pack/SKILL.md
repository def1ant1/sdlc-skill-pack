---
name: hr-operations-phase-pack
description: Cross-functional hr operations skill pack with support-only recommendations and mandatory human governance.
---

## Role
Provides orchestrated support workflows for hr operations with KPI-linked recommendations.
