---
name: account-expansion-intelligence
description: Phase 107 business skill using canonical entity/event outputs and policy-gated actions.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Execute account expansion intelligence workflows while producing only canonical entity/event artifacts.
