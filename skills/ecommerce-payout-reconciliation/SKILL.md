---
name: ecommerce-payout-reconciliation
description: Reconcile ecommerce payouts with orders, fees, tax, and ledger entities.
metadata:
  version: 0.1.0
  category: ecommerce
  owner: Finance & Tax
...
## Mission
Provide decision support for ecommerce payout reconciliation in **draft mode** with explicit evidence, assumptions, and confidence scoring.
