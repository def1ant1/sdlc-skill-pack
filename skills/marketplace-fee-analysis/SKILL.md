...
metadata:
  ...
  maturity: beta
use_when:
- Request requires marketplace fee analysis workflows with channel and SKU-level outputs.
do_not_use_when:
...
## Role
Provide structured analysis for marketplace fee analysis in marketplace operations.
