---
name: product-authenticity-risk-analysis
...
# Product Authenticity Risk Analysis

## Role
Execute product authenticity risk analysis workflows while producing canonical, policy-aware decision-support artifacts.
