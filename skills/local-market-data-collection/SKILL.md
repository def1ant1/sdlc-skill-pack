---
name: local-market-data-collection
description: Phase 112 business skill using canonical entity/event outputs and policy-gated actions.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Execute local market data collection workflows while producing only canonical entity/event artifacts.

## Routing
- use_when: Request maps to phase 112 capabilities and requires structured decision support.
