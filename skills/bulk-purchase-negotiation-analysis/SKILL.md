---
name: bulk-purchase-negotiation-analysis
description: Analyze bulk-purchase proposals and counteroffer ranges without autonomous commitment.
metadata:
  version: 0.1.0
  category: ecommerce
...
# Bulk Purchase Negotiation Analysis

## Mission
Provide decision support for bulk purchase negotiation analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
