---
name: regional-scarcity-scoring
description: Score regional scarcity and replenishment risk for acquisition and listing timing.
metadata:
  version: 0.1.0
  category: ecommerce
...
# Regional Scarcity Scoring

## Mission
Provide decision support for regional scarcity scoring in **draft mode** with explicit evidence, assumptions, and confidence scoring.
