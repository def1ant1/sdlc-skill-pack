...
description: Product Title Optimization skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support product title optimization decisions in **draft mode** by default; block publish actions pending explicit approval.
