---
name: marketplace-profitability-analysis
...
metadata:
  ...
  maturity: beta
use_when:
- Request requires marketplace profitability analysis workflows with channel and SKU-level outputs.
do_not_use_when:
- Task is unrelated to pricing intelligence or lacks marketplace context.
---

# marketplace profitability analysis

## Role
Provide structured analysis for marketplace profitability analysis in marketplace operations.
