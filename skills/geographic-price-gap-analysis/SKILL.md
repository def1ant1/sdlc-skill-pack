---
name: geographic-price-gap-analysis
description: Compare regional prices and quantify geographic arbitrage spread after logistics impacts.
metadata:
  version: 0.1.0
  category: ecommerce
...
# Geographic Price Gap Analysis

## Mission
Provide decision support for geographic price gap analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
