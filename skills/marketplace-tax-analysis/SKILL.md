---
name: marketplace-tax-analysis
description: Support marketplace tax treatment analysis with jurisdiction-level professional-review flags.
metadata:
  version: 0.1.0
  category: ecommerce
  owner: Finance & Tax
...
# Marketplace Tax Analysis

## Mission
Provide decision support for marketplace tax analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
