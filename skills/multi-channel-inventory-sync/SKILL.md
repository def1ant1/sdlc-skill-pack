...
description: Multi Channel Inventory Sync skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support multi channel inventory sync decisions in **draft mode** by default; block publish actions pending explicit approval.
