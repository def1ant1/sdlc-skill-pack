---
name: purchase-order-optimization
...
## Role
Execute purchase order optimization workflows while producing only canonical entity/event artifacts.

## Routing
- use_when: Request maps to phase 110 capabilities and requires structured decision support.
