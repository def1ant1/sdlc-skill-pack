---
name: sales-tax-nexus-analysis
description: Assess sales-tax nexus exposure and compliance checkpoints by jurisdiction.
metadata:
  version: 0.1.0
  category: ecommerce
  owner: Finance & Tax
...
## Mission
Provide decision support for sales tax nexus analysis in **draft mode** with explicit evidence, assumptions, and confidence scoring.
