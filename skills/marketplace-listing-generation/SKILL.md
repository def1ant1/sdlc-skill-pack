---
name: marketplace-listing-generation
description: Marketplace Listing Generation skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support marketplace listing generation decisions in **draft mode** by default; block publish actions pending explicit approval.
