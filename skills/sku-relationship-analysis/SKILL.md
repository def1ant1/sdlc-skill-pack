---
name: sku-relationship-analysis
description: Sku Relationship Analysis skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
# Sku Relationship Analysis

## Mission
Support sku relationship analysis decisions in **draft mode** by default; block publish actions pending explicit approval.
