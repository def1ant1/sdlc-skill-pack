---
name: supplier-risk-negotiation-support
description: Blend supplier risk signals into negotiation posture with escalation and no-auto-commitment guardrails.
metadata:
  version: 0.1.0
  category: ecommerce
...
# Supplier Risk Negotiation Support

## Mission
Provide decision support for supplier risk negotiation support in **draft mode** with explicit evidence, assumptions, and confidence scoring.
