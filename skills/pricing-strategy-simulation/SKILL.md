...
description: Ecommerce extension skill for pricing-strategy-simulation with organizational-memory-aware analysis and safety controls.
metadata:
  version: 0.1.0
...
## Purpose
Supports ecommerce decision workflows for **pricing-strategy-simulation**.
