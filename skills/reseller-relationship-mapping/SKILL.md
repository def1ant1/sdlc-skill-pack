---
name: reseller-relationship-mapping
description: Ecommerce extension skill for reseller-relationship-mapping with organizational-memory-aware analysis and safety controls.
metadata:
  version: 0.1.0
...
## Purpose
Supports ecommerce decision workflows for **reseller-relationship-mapping**.
