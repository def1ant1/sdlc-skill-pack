---
name: vendor-procurement-phase-pack
description: Cross-functional vendor procurement skill pack with support-only recommendations and mandatory human governance.
---

## Role
Provides orchestrated support workflows for vendor procurement with KPI-linked recommendations.
