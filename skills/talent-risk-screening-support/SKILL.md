---
name: talent-risk-screening-support
description: Support-only talent risk summaries with anti-bias controls and explicit no-automated-decision messaging.
metadata:
  version: "9.0.0"
  category: sdlc
  owner: Apotheon
...
## Role
Support-only talent risk summaries with anti-bias controls and explicit no-automated-decision messaging.
