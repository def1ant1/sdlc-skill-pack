---
name: listing-compliance-validation
description: Listing Compliance Validation skill for ecommerce operations with draft mode and publish approval gates.
metadata:
  version: 0.1.0
  category: ecommerce
...
## Mission
Support listing compliance validation decisions in **draft mode** by default; block publish actions pending explicit approval.
